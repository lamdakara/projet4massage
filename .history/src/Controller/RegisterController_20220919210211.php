...
class RegisterController extends AbstractController
{
    ...
    public function index(Request $request, UserPasswordHasherInterface $passwordHasher, MailjetService $mailjetService, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (!$search_email) {
                ...
                $mailjetService->send($user->getEmail(), $user->getFirstname(), 'Bienvenue sur Lili Giroud', $content);
